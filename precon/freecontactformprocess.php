...
if(isset($_POST['Email_Address'])) {
	...
	$institute = $_POST['Institute_Name']; // required
  ...
  if(strlen($institute) < 2) {
  	$error_message .= 'The Institute Name you entered do not appear to be valid.<br />';
  }
  ...
  if(strlen($error_message) > 0) {
	...
	$email_message = "New registration details:\r\n";
	...
	$email_message .= "Institute: ".clean_string($institute)."\r\n";
